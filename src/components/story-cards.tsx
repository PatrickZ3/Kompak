                ...
                <DraggableCard key={story.id} story={story}>
                    {(listeners) => (
                        <Card className="@container/card relative" data-slot="card">
                            <CardHeader>
                                <CardTitle className="text-lg font-bold tabular-nums" {...listeners}>
                                    {story.story}
                                </CardTitle>
                            </CardHeader>
                            <div className="absolute right-4 top-4" data-ignore-drag>
                                <DropdownMenu>
                            ...
                            <div className="flex items-center px-6">
                                ...
                                <CardDescription className="pl-2 text-xs">{formatTimeLabel(story)}</CardDescription>
                            </div>
